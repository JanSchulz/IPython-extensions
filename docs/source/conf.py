...
if ipextrelease['_version_extra'] == 'dev':
    rst_prolog = """
    .. note::

        This documentation is for a development version of IPython-extensions. There 
        may be significant differences from the latest stable release.
...
project = 'IPython-extensions'
copyright = 'The IPython-extensions Development Team'

# ghissue config
github_project_url = "https://github.com/ipython-contrib/IPython-extensions"
...
release = "%s" % ipextrelease['__version__']
# Just the X.Y.Z part, no '-dev'
version = ipextrelease['__version__'].split('-', 1)[0]
...
# template names.
#html_additional_pages = {'interactive/htmlnotebook': 'notebook_redirect.html',}
...
htmlhelp_basename = 'ipythonextensionsdoc'
...
texinfo_documents = [
  (master_doc, 'ipython', 'IPython-extensions Documentation',
